...
move MOVE_POUND,               0x0000,    SPLIT_PHYSICAL,              40,    TYPE_NORMAL,          100,      35,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_TOUGH
move MOVE_KARATE_CHOP,         0x002B,    SPLIT_PHYSICAL,              50,    TYPE_FIGHTING,        100,      25,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_TOUGH
move MOVE_DOUBLE_SLAP,         0x001D,    SPLIT_PHYSICAL,              15,    TYPE_NORMAL,          85,       10,            0,      0x0000,         0,       0x73,      0x07,    CONTEST_TOUGH
move MOVE_COMET_PUNCH,         0x001D,    SPLIT_PHYSICAL,              18,    TYPE_NORMAL,          85,       15,            0,      0x0000,         0,       0x73,      0x07,    CONTEST_TOUGH
...
move MOVE_FIRE_PUNCH,          0x0004,    SPLIT_PHYSICAL,              75,    TYPE_FIRE,            100,      15,            10,     0x0000,         0,       0x13,      0x11,    CONTEST_BEAUTY
move MOVE_ICE_PUNCH,           0x0005,    SPLIT_PHYSICAL,              75,    TYPE_ICE,             100,      15,            10,     0x0000,         0,       0x13,      0x11,    CONTEST_BEAUTY
move MOVE_THUNDER_PUNCH,       0x0006,    SPLIT_PHYSICAL,              75,    TYPE_ELECTRIC,        100,      15,            10,     0x0000,         0,       0x13,      0x11,    CONTEST_COOL
move MOVE_SCRATCH,             0x0000,    SPLIT_PHYSICAL,              40,    TYPE_NORMAL,          100,      35,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_TOUGH
...
move MOVE_GUST,                0x0095,    SPLIT_SPECIAL,               40,    TYPE_FLYING,          100,      35,            0,      0x0000,         0,       0x32,      0x05,    CONTEST_SMART
...
move MOVE_VINE_WHIP,           0x0000,    SPLIT_PHYSICAL,              45,    TYPE_GRASS,           100,      25,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_COOL
move MOVE_STOMP,               0x0096,    SPLIT_PHYSICAL,              65,    TYPE_NORMAL,          100,      20,            30,     0x0000,         0,       0x53,      0x05,    CONTEST_TOUGH
move MOVE_DOUBLE_KICK,         0x002C,    SPLIT_PHYSICAL,              30,    TYPE_FIGHTING,        100,      30,            0,      0x0000,         0,       0x73,      0x07,    CONTEST_COOL
...
move MOVE_SAND_ATTACK,         0x0017,    SPLIT_STATUS,                0,     TYPE_GROUND,          100,      15,            0,      0x0000,         0,       0x16,      0x13,    CONTEST_CUTE
...
move MOVE_TACKLE,              0x0000,    SPLIT_PHYSICAL,              40,    TYPE_NORMAL,          100,      35,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_TOUGH
...
move MOVE_TAIL_WHIP,           0x0013,    SPLIT_STATUS,                0,     TYPE_NORMAL,          100,      30,            0,      0x0004,         0,       0x56,      0x13,    CONTEST_CUTE
move MOVE_POISON_STING,        0x0002,    SPLIT_PHYSICAL,              15,    TYPE_POISON,          100,      35,            30,     0x0000,         0,       0x12,      0x13,    CONTEST_SMART
move MOVE_TWINEEDLE,           0x004D,    SPLIT_PHYSICAL,              25,    TYPE_BUG,             100,      20,            20,     0x0000,         0,       0x52,      0x07,    CONTEST_COOL
move MOVE_PIN_MISSILE,         0x001D,    SPLIT_PHYSICAL,              14,    TYPE_BUG,             85,       20,            0,      0x0000,         0,       0x72,      0x07,    CONTEST_COOL
move MOVE_LEER,                0x0013,    SPLIT_STATUS,                0,     TYPE_NORMAL,          100,      30,            0,      0x0004,         0,       0x16,      0x13,    CONTEST_COOL
move MOVE_BITE,                0x001F,    SPLIT_PHYSICAL,              60,    TYPE_DARK,            100,      25,            30,     0x0000,         0,       0x13,      0x05,    CONTEST_TOUGH
move MOVE_GROWL,               0x0012,    SPLIT_STATUS,                0,     TYPE_NORMAL,          100,      40,            0,      0x0004,         0,       0x56,      0x13,    CONTEST_CUTE
...
move MOVE_ACID,                0x0048,    SPLIT_SPECIAL,               40,    TYPE_POISON,          100,      30,            10,     0x0004,         0,       0x12,      0x05,    CONTEST_SMART
move MOVE_EMBER,               0x0004,    SPLIT_SPECIAL,               40,    TYPE_FIRE,            100,      25,            10,     0x0000,         0,       0x52,      0x05,    CONTEST_BEAUTY
...
move MOVE_WATER_GUN,           0x0000,    SPLIT_SPECIAL,               40,    TYPE_WATER,           100,      25,            0,      0x0000,         0,       0x32,      0x05,    CONTEST_CUTE
...
move MOVE_BLIZZARD,            0x0104,    SPLIT_SPECIAL,               120,   TYPE_ICE,             70,       5,             10,     0x0004,         0,       0x92,      0x11,    CONTEST_BEAUTY
...
move MOVE_HYPER_BEAM,          0x0050,    SPLIT_SPECIAL,               150,   TYPE_NORMAL,          90,       5,             0,      0x0000,         0,       0xB2,      0x16,    CONTEST_COOL
move MOVE_PECK,                0x0000,    SPLIT_PHYSICAL,              35,    TYPE_FLYING,          100,      35,            0,      0x0000,         0,       0x73,      0x05,    CONTEST_COOL
...
move MOVE_ABSORB,              0x0003,    SPLIT_SPECIAL,               20,    TYPE_GRASS,           100,      25,            0,      0x0000,         0,       0x12,      0x14,    CONTEST_SMART
move MOVE_MEGA_DRAIN,          0x0003,    SPLIT_SPECIAL,               40,    TYPE_GRASS,           100,      15,            0,      0x0000,         0,       0x12,      0x14,    CONTEST_SMART
move MOVE_LEECH_SEED,          0x0054,    SPLIT_STATUS,                0,     TYPE_GRASS,           90,       10,            0,      0x0000,         0,       0x16,      0x15,    CONTEST_SMART
...
move MOVE_THUNDER_SHOCK,       0x0006,    SPLIT_SPECIAL,               40,    TYPE_ELECTRIC,        100,      30,            10,     0x0000,         0,       0x12,      0x05,    CONTEST_COOL
...
move MOVE_THUNDER,             0x0098,    SPLIT_SPECIAL,               120,   TYPE_ELECTRIC,        70,       10,            30,     0x0000,         0,       0x92,      0x11,    CONTEST_COOL
move MOVE_ROCK_THROW,          0x0000,    SPLIT_PHYSICAL,              50,    TYPE_ROCK,            90,       15,            0,      0x0000,         0,       0x32,      0x05,    CONTEST_TOUGH
...
move MOVE_DIG,                 0x0100,    SPLIT_PHYSICAL,              80,    TYPE_GROUND,          100,      10,            0,      0x0000,         0,       0x33,      0x06,    CONTEST_SMART
move MOVE_TOXIC,               0x0021,    SPLIT_STATUS,                0,     TYPE_POISON,          85,       10,            0,      0x0000,         0,       0x16,      0x13,    CONTEST_SMART
move MOVE_CONFUSION,           0x004C,    SPLIT_SPECIAL,               50,    TYPE_PSYCHIC,         100,      25,            10,     0x0000,         0,       0x12,      0x05,    CONTEST_SMART
...
move MOVE_QUICK_ATTACK,        0x0067,    SPLIT_PHYSICAL,              40,    TYPE_NORMAL,          100,      30,            0,      0x0000,         1,       0x73,      0x01,    CONTEST_COOL
...
move MOVE_DOUBLE_TEAM,         0x0010,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        15,            0,      0x0010,         0,       0x48,      0x01,    CONTEST_COOL
...
move MOVE_MINIMIZE,            0x006C,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        20,            0,      0x0010,         0,       0x08,      0x0D,    CONTEST_CUTE
move MOVE_SMOKESCREEN,         0x0017,    SPLIT_STATUS,                0,     TYPE_NORMAL,          100,      20,            0,      0x0000,         0,       0x16,      0x0A,    CONTEST_SMART
...
move MOVE_DEFENSE_CURL,        0x009C,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        40,            0,      0x0010,         0,       0x48,      0x0D,    CONTEST_CUTE
...
move MOVE_FIRE_BLAST,          0x0004,    SPLIT_SPECIAL,               120,   TYPE_FIRE,            85,       5,             10,     0x0000,         0,       0x92,      0x11,    CONTEST_BEAUTY
...
move MOVE_SKULL_BASH,          0x0091,    SPLIT_PHYSICAL,              100,   TYPE_NORMAL,          100,      15,            100,    0x0000,         0,       0x33,      0x06,    CONTEST_TOUGH
...
move MOVE_LEECH_LIFE,          0x0003,    SPLIT_PHYSICAL,              20,    TYPE_BUG,             100,      15,            0,      0x0000,         0,       0x13,      0x14,    CONTEST_SMART
...
move MOVE_DIZZY_PUNCH,         0x004C,    SPLIT_PHYSICAL,              70,    TYPE_NORMAL,          100,      10,            20,     0x0000,         0,       0x13,      0x10,    CONTEST_COOL
move MOVE_SPORE,               0x0001,    SPLIT_STATUS,                0,     TYPE_GRASS,           100,      15,            0,      0x0000,         0,       0x16,      0x0A,    CONTEST_BEAUTY
move MOVE_FLASH,               0x0017,    SPLIT_STATUS,                0,     TYPE_NORMAL,          100,      20,            0,      0x0000,         0,       0x96,      0x0A,    CONTEST_BEAUTY
...
move MOVE_FURY_SWIPES,         0x001D,    SPLIT_PHYSICAL,              18,    TYPE_NORMAL,          80,       15,            0,      0x0000,         0,       0x73,      0x07,    CONTEST_TOUGH
...
move MOVE_SHARPEN,             0x000A,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        30,            0,      0x0010,         0,       0x48,      0x0B,    CONTEST_CUTE
...
move MOVE_TRIPLE_KICK,         0x0068,    SPLIT_PHYSICAL,              10,    TYPE_FIGHTING,        90,       10,            0,      0x0000,         0,       0x73,      0x07,    CONTEST_COOL
...
move MOVE_POWDER_SNOW,         0x0005,    SPLIT_SPECIAL,               40,    TYPE_ICE,             100,      25,            10,     0x0004,         0,       0x12,      0x05,    CONTEST_BEAUTY
...
move MOVE_GIGA_DRAIN,          0x0003,    SPLIT_SPECIAL,               60,    TYPE_GRASS,           100,      10,            0,      0x0000,         0,       0x12,      0x14,    CONTEST_SMART
...
move MOVE_STEEL_WING,          0x008A,    SPLIT_PHYSICAL,              70,    TYPE_STEEL,           90,       25,            10,     0x0000,         0,       0x33,      0x05,    CONTEST_COOL
...
move MOVE_DRAGON_BREATH,       0x0006,    SPLIT_SPECIAL,               60,    TYPE_DRAGON,          100,      20,            30,     0x0000,         0,       0x32,      0x11,    CONTEST_COOL
...
move MOVE_IRON_TAIL,           0x0045,    SPLIT_PHYSICAL,              100,   TYPE_STEEL,           75,       15,            30,     0x0000,         0,       0x13,      0x12,    CONTEST_COOL
move MOVE_METAL_CLAW,          0x008B,    SPLIT_PHYSICAL,              50,    TYPE_STEEL,           95,       35,            10,     0x0000,         0,       0x13,      0x12,    CONTEST_COOL
...
move MOVE_TWISTER,             0x0092,    SPLIT_SPECIAL,               40,    TYPE_DRAGON,          100,      20,            20,     0x0004,         0,       0x32,      0x05,    CONTEST_COOL
...
move MOVE_ANCIENT_POWER,       0x008C,    SPLIT_SPECIAL,               60,    TYPE_ROCK,            100,      5,             10,     0x0000,         0,       0x12,      0x12,    CONTEST_TOUGH
...
move MOVE_DIVE,                0x00FF,    SPLIT_PHYSICAL,              80,    TYPE_WATER,           100,      10,            0,      0x0000,         0,       0x33,      0x06,    CONTEST_BEAUTY
...
move MOVE_BLAST_BURN,          0x0050,    SPLIT_SPECIAL,               150,   TYPE_FIRE,            90,       5,             0,      0x0000,         0,       0x32,      0x16,    CONTEST_BEAUTY
move MOVE_HYDRO_CANNON,        0x0050,    SPLIT_SPECIAL,               150,   TYPE_WATER,           90,       5,             0,      0x0000,         0,       0xB2,      0x16,    CONTEST_BEAUTY
move MOVE_METEOR_MASH,         0x008B,    SPLIT_PHYSICAL,              100,   TYPE_STEEL,           85,       10,            20,     0x0000,         0,       0x33,      0x12,    CONTEST_COOL
move MOVE_ASTONISH,            0x001F,    SPLIT_PHYSICAL,              30,    TYPE_GHOST,           100,      15,            30,     0x0000,         0,       0x53,      0x05,    CONTEST_SMART
...
move MOVE_SILVER_WIND,         0x008C,    SPLIT_SPECIAL,               60,    TYPE_BUG,             100,      5,             10,     0x0000,         0,       0x32,      0x04,    CONTEST_BEAUTY
...
move MOVE_BULLET_SEED,         0x001D,    SPLIT_PHYSICAL,              25,    TYPE_GRASS,           100,      30,            0,      0x0000,         0,       0x72,      0x07,    CONTEST_COOL
move MOVE_AERIAL_ACE,          0x0011,    SPLIT_PHYSICAL,              60,    TYPE_FLYING,          0,        20,            0,      0x0000,         0,       0x33,      0x11,    CONTEST_COOL
move MOVE_ICICLE_SPEAR,        0x001D,    SPLIT_PHYSICAL,              10,    TYPE_ICE,             100,      30,            0,      0x0000,         0,       0x72,      0x07,    CONTEST_BEAUTY
...
move MOVE_HOWL,                0x000A,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        40,            0,      0x0010,         0,       0x08,      0x0B,    CONTEST_COOL
move MOVE_DRAGON_CLAW,         0x0000,    SPLIT_PHYSICAL,              80,    TYPE_DRAGON,          100,      15,            0,      0x0000,         0,       0x33,      0x11,    CONTEST_COOL
move MOVE_FRENZY_PLANT,        0x0050,    SPLIT_SPECIAL,               150,   TYPE_GRASS,           90,       5,             0,      0x0000,         0,       0xB2,      0x16,    CONTEST_COOL
move MOVE_BULK_UP,             0x00D0,    SPLIT_STATUS,                0,     TYPE_FIGHTING,        0,        20,            0,      0x0010,         0,       0x48,      0x0B,    CONTEST_BEAUTY
move MOVE_BOUNCE,              0x0107,    SPLIT_PHYSICAL,              85,    TYPE_FLYING,          85,       5,             30,     0x0000,         0,       0x33,      0x06,    CONTEST_CUTE
move MOVE_MUD_SHOT,            0x0046,    SPLIT_SPECIAL,               55,    TYPE_GROUND,          95,       15,            100,    0x0000,         0,       0x32,      0x02,    CONTEST_TOUGH
...
move MOVE_ACUPRESSURE,         0x00E2,    SPLIT_STATUS,                0,     TYPE_NORMAL,          0,        30,            0,      0x0200,         0,       0x48,      0x0B,    CONTEST_COOL
...
move MOVE_POWER_TRICK,         0x00EE,    SPLIT_STATUS,                0,     TYPE_PSYCHIC,         0,        10,            0,      0x0010,         0,       0x40,      0x10,    CONTEST_COOL
...
move MOVE_MAGNET_RISE,         0x00FC,    SPLIT_STATUS,                0,     TYPE_ELECTRIC,        0,        10,            0,      0x0010,         0,       0x00,      0x0D,    CONTEST_CUTE
...
move MOVE_DRAGON_PULSE,        0x0000,    SPLIT_SPECIAL,               90,    TYPE_DRAGON,          100,      10,            0,      0x0000,         0,       0x32,      0x04,    CONTEST_SMART
move MOVE_DRAGON_RUSH,         0x001F,    SPLIT_PHYSICAL,              100,   TYPE_DRAGON,          75,       10,            20,     0x0000,         0,       0x33,      0x12,    CONTEST_COOL
move MOVE_POWER_GEM,           0x0000,    SPLIT_SPECIAL,               70,    TYPE_ROCK,            100,      20,            0,      0x0000,         0,       0x32,      0x05,    CONTEST_BEAUTY
move MOVE_DRAIN_PUNCH,         0x0003,    SPLIT_PHYSICAL,              75,    TYPE_FIGHTING,        100,      10,            0,      0x0000,         0,       0x33,      0x14,    CONTEST_BEAUTY
...
move MOVE_GIGA_IMPACT,         0x0050,    SPLIT_PHYSICAL,              150,   TYPE_NORMAL,          90,       5,             0,      0x0000,         0,       0xB3,      0x16,    CONTEST_BEAUTY
...
move MOVE_MIRROR_SHOT,         0x0049,    SPLIT_SPECIAL,               65,    TYPE_STEEL,           85,       10,            30,     0x0000,         0,       0x32,      0x11,    CONTEST_CUTE
move MOVE_FLASH_CANNON,        0x0048,    SPLIT_SPECIAL,               80,    TYPE_STEEL,           100,      10,            10,     0x0000,         0,       0x32,      0x11,    CONTEST_SMART
...
move MOVE_TRICK_ROOM,          0x0103,    SPLIT_STATUS,                0,     TYPE_PSYCHIC,         0,        5,             0,      0x0040,         -7,      0x10,      0x0E,    CONTEST_CUTE
...
move MOVE_ROCK_WRECKER,        0x0050,    SPLIT_PHYSICAL,              150,   TYPE_ROCK,            90,       5,             0,      0x0000,         0,       0xB2,      0x16,    CONTEST_TOUGH
...
move MOVE_BUG_BITE,            0x00E0,    SPLIT_PHYSICAL,              60,    TYPE_BUG,             100,      20,            0,      0x0000,         0,       0x73,      0x0C,    CONTEST_TOUGH
...
move MOVE_ROAR_OF_TIME,        0x0050,    SPLIT_SPECIAL,               150,   TYPE_DRAGON,          90,       5,             0,      0x0000,         0,       0x32,      0x16,    CONTEST_COOL
move MOVE_SPACIAL_REND,        0x002B,    SPLIT_SPECIAL,               100,   TYPE_DRAGON,          95,       5,             0,      0x0000,         0,       0xB2,      0x04,    CONTEST_TOUGH
...
move MOVE_OMINOUS_WIND,        0x008C,    SPLIT_SPECIAL,               60,    TYPE_GHOST,           100,      5,             10,     0x0000,         0,       0x32,      0x0B,    CONTEST_SMART
