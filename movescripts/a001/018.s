...
_0080:
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x7, _044C
    abilitycheck 0x0, BATTLER_ADDL_EFFECT, ABILITY_SOUNDPROOF, _00C0
    if IF_MASK, VAR_FIELD_EFFECT, 0xF00, _0494
_00C0:
    ifmonstat IF_NOTEQUAL, BATTLER_ADDL_EFFECT, 0x34, 0x0, _03B8
    goto _0250
_00E0:
...
_017C:
    ...
    checknostatus BATTLER_ADDL_EFFECT, _03B8
_019C:
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x7, _044C
...
_02C4:
    ...
    waitmessage
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x3B, 0x200400C0, _0308
...
_0494:
    if IF_EQUAL, VAR_05, 0x2, _0548
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x35, 0x70, _04E0
    wait 0x1E
