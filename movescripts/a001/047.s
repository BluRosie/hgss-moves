...
_00B8:
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x8, _03E4
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x80, _03E4
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1B, 0x3, _03E4
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1C, 0x3, _03E4
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1B, 0x8, _03E4
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1C, 0x8, _03E4
    ifmonstat IF_NOTEQUAL, BATTLER_ADDL_EFFECT, 0x34, 0x0, _03E4
...
_0204:
    ...
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x8, _04A4
    ifmonstat IF_MASK, BATTLER_ADDL_EFFECT, 0x34, 0x80, _04A4
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1B, 0x3, _04EC
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1C, 0x3, _04EC
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1B, 0x8, _04EC
    ifmonstat IF_EQUAL, BATTLER_ADDL_EFFECT, 0x1C, 0x8, _04EC
    ifmonstat IF_NOTEQUAL, BATTLER_ADDL_EFFECT, 0x34, 0x0, _0450
...
_032C:
    ...
    waitmessage
    changevartomonvalue VAR_OP_SETMASK, BATTLER_ADDL_EFFECT, VAR_BATTLE_STATUS, 0x80
